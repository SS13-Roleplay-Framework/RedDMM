# Strong Dream Map Maker &middot; [![GitHub release](https://img.shields.io/github/release/SpaiR/RedDMM.svg?label=RedDMM)](https://github.com/SpaiR/RedDMM/releases/latest) [![Github All Releases](https://img.shields.io/github/downloads/SpaiR/RedDMM/total.svg?logo=github)](https://github.com/SpaiR/RedDMM/releases) ![CI](https://github.com/SpaiR/RedDMM/workflows/CI/badge.svg)

<p align="center"><b>Download RedDMM</b></p>
<p align="center">
...
<img align="right" width="150" src="https://raw.githubusercontent.com/SpaiR/RedDMM/master/docs/sdmm-logo.png" alt="RedDMM Logo">

RedDMM is an alternative yet robust map editor for BYOND.
...
<p align="center">
  <img width="450" src="https://raw.githubusercontent.com/SpaiR/RedDMM/master/docs/sdmm-example.png" alt="RedDMM Example">
</p>

## How to Use

RedDMM is a single executable, which doesn't require any installation.
...
[Release](https://github.com/SpaiR/RedDMM/releases/latest) page contains all distributed files. It also has `sha256` hashes info for every executable for validation purposes.

### CLI Usage

RedDMM do support CLI to quickly open maps. Provide `.dme` or `.dmm` files as program arguments:

###### With DME
```
RedDMM.exe path/to/environment.dme ./map1.dmm ../path/map2.dmm
```

###### Without DME
```
RedDMM.exe ./map1.dmm ../path/map2.dmm
```
...
RedDMM was developed without any monetization in mind. The main motivation is the enthusiasm for creating cool stuff.\
...
**A.** Verify them using `sha256` hashes, available on the [releases page](https://github.com/SpaiR/RedDMM/releases/latest).

**Q.** But how can I trust executables on the release page?\
**A.** Executables are built with the [CI pipeline](https://github.com/SpaiR/RedDMM/actions/workflows/ci.yml). You can verify the process yourself or build the executables manually from the source code.

**Q.** How to uninstall the editor?\
**A.** RedDMM doesn't require installation, so no specific uninstallation process is needed. Simply delete the executable and, if desired, its directory on your OS to remove editor data.

**Q.** Where do I find editor data?\
**A.** For Windows: `C:\Users\USER\AppData\Roaming\RedDMM`, for Linux/macOS: `~/.RedDMM`.
...
RedDMM uses [SpacemanDMM](https://github.com/SpaceManiac/SpacemanDMM) parser made
